...
_component_data = {
    "GC_TE_1310_8degOxide_BB": (
        "EBeam",
        "GCs_BB",
        [((0.0, 0.0), 180, "TE_1310_350"), ((-20.4, 0.0), (_vx8, 0, _vy8), _waist, 90)],
        None,
    ),
    "GC_TE_1550_8degOxide_BB": (
        "EBeam",
        "GCs_BB",
        [((0.0, 0.0), 180, "TE_1550_500"), ((-20.4, 0.0), (_vx8, 0, _vy8), _waist, 90)],
        None,
    ),
    ...
    "GC_TM_1310_8degOxide_BB": (
        "EBeam",
        "GCs_BB",
        [((0.0, 0.0), 180, "TE_1310_350"), ((-20.4, 0.0), (_vx8, 0, _vy8), _waist, 0)],
        None,
    ),
    "GC_TM_1550_8degOxide_BB": (
        "EBeam",
        "GCs_BB",
        [((0.0, 0.0), 180, "TM_1550_500"), ((-20.4, 0.0), (_vx8, 0, _vy8), _waist, 0)],
        None,
    ),
    ...
    "ebeam_gc_te1550": (
        "EBeam",
        "ebeam_gc_te1550",
        [((0.0, 0.0), 180, "TE_1550_500"), ((-20.4, 0.0), (_te1550_vx, 0, _te1550_vy), _waist, 90)],
        (
            pf.Tidy3DModel,
    ...
    "ebeam_gc_tm1550": (
        "EBeam",
        "ebeam_gc_tm1550",
        [((0.0, 0.0), 180, "TM_1550_500"), ((-24.4, 0.0), (_tm1550_vx, 0, _tm1550_vy), _waist, 0)],
        (
            pf.Tidy3DModel,
    ...
    "GC_SiN_TE_1550_8degOxide_BB": (
        "EBeam_SiN",
        "GC_SiN_TE_1550_8degOxide_BB",
        [((0.0, 0.0), 180, "SiN_TE_1550_750"), ((-29.7, 0.0), (_vx8, 0, _vy8), _waist, 90)],
        None,
    ),
    ...
    "ebeam_gc_te895": (
        ...
        (pf.Tidy3DModel, {"symmetry": (0, -1, 0), "bounds": ((None, -10, None), (25, 10, None))}),
    ),
...
def component(cell_name: str, technology: pf.Technology = None, **model_kwargs) -> pf.Component:
    ...
    for data in port_data:
        if len(data) == 3:
            ...
            port = pf.GaussianPort(data[0] + (z,), data[1], data[2], polarization_angle=data[3])
        c.add_port(port)
